...
-- describe() is where you test suite is broken up into components, it groups together related tests. it() is used to describe individual tests.  


1. What is the point of `Test Driven Development`? 

--What do you think about this approach? to learn to write good code that passes tests earlier than relying on future testing to figure out bugs. It's scary because it can be time consuming but i really would like to master it since it will make me a better programmer.

1. Mention three types of automated tests.

-- 1. unit tests 2. component testing 3. snapshot testing.
